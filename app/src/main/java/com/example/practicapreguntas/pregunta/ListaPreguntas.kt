...
class ListaPreguntas() {
    companion object {
        ...
        val pregunta2 = Pregunta("Sonic Team ha hecho al menos 1 buen juego en los últimos 20 años", R.drawable.sanic, false)
        val pregunta3 = Pregunta("Los juegos \"competitivos\" son una pérdida de tiempo para el 99% de los jugadores", R.drawable.door_stuck, true)
